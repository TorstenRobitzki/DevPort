...
#define CONF_SERCOM_5_I2CM_TRISE 			CONF_SERCOM_0_I2CM_TRISE
#define CONF_SERCOM_5_I2CM_MEXTTOEN 		0
#define CONF_SERCOM_5_I2CM_SEXTTOEN 		0
#define CONF_SERCOM_5_I2CM_INACTOUT 		0x0
#define CONF_SERCOM_5_I2CM_LOWTOUT			CONF_SERCOM_0_I2CM_LOWTOUT
...
#define CONF_SERCOM_5_I2CM_BAUD_BAUDLOW 	CONF_SERCOM_0_I2CM_BAUD_BAUDLOW
#define CONF_SERCOM_5_I2CM_BAUD_RATE 		CONF_SERCOM_0_I2CM_BAUD_RATE
#define CONF_GCLK_SERCOM5_CORE_FREQUENCY	CONF_GCLK_SERCOM0_CORE_FREQUENCY
