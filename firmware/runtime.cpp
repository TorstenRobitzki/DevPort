...
/* Initialize segments */
extern "C" uint32_t _sfixed;
extern "C" uint32_t _efixed;
extern "C" uint32_t _etext;
extern "C" uint32_t _srelocate;
extern "C" uint32_t _erelocate;
extern "C" uint32_t _szero;
extern "C" uint32_t _ezero;
extern "C" uint32_t _sstack;
...
/* Exception Table */
extern "C" __attribute__((section(".vectors"))) const DeviceVectors exception_table
    = {
